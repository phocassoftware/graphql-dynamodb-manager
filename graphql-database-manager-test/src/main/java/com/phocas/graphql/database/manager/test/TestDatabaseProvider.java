...
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.createHistoryTable;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.createTable;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.findFreePort;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.getDatabaseManager;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.getEmbeddedDatabase;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.startDynamoAsyncClient;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.startDynamoClient;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.startDynamoServer;
import static com.phocas.graphql.database.manager.test.DynamoDbInitializer.startDynamoStreamClient;
...
import com.phocas.graphql.database.manager.test.annotations.TestDatabase;
