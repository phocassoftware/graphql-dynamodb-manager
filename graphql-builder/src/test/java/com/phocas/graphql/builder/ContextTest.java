...
import com.phocas.graphql.builder.context.GraphContext;
...
public class ContextTest {
	...
	private ExecutionResult execute(String query, Consumer<ExecutionInput.Builder> modify) {
		GraphQL schema = GraphQL
			.newGraphQL(new IntrospectionWithDirectivesSupport().apply(SchemaBuilder.build("com.phocas.graphql.builder.context")))
			.build();
