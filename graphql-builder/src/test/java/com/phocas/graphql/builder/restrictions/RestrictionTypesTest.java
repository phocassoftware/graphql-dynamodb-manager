 ...
 * the License.
 */
package com.phocas.graphql.builder.restrictions;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.JsonMappingException;
import com.phocas.graphql.builder.SchemaBuilder;
...
public class RestrictionTypesTest {
	...
	public static void init() throws ReflectiveOperationException {
		schema = GraphQL.newGraphQL(SchemaBuilder.build("com.phocas.graphql.builder.restrictions.parameter")).build();
	}
